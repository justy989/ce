...
CeVimParseResult_t ce_vim_parse_motion_visual(CeVimAction_t* action, const CeVim_t* vim, CeRune_t key);
...
CE_VIM_DECLARE_VERB_FUNC(ce_vim_verb_set_paste_clipboard_to_highlighted);
