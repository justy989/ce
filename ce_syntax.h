...
typedef enum{
     ...
     CE_SYNTAX_COLOR_COMPLETE_SELECTED,
     CE_SYNTAX_COLOR_COMPLETE_MATCH,
     CE_SYNTAX_COLOR_LINE_NUMBER,
     CE_SYNTAX_COLOR_MULTIPLE_CURSOR_INACTIVE,
     CE_SYNTAX_COLOR_MULTIPLE_CURSOR_ACTIVE,
     CE_SYNTAX_COLOR_LINE_EXTENDS_PASSED_VIEW,
